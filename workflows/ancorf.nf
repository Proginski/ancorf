...
workflow {
	...
	GET_PHYLIP_NAMES(params.genomes, params.original_tree)


	// Get a FASTA with the CDS and its neighbor nucleotide homologous sequences.
	GET_ALIGNMENT_FASTA(ready_neighbors,
				queries_ch, 
				params.focal,
				params.genomes,
	...
	NUCLEOTIDE_ALIGNMENT(GET_ALIGNMENT_FASTA.out.toali,
	...
	CONVERT_ALIGNED_FASTA_TO_PHYLIP(NUCLEOTIDE_ALIGNMENT.out.NT_alignment,
	...
	PHYML_TREE(CONVERT_ALIGNED_FASTA_TO_PHYLIP.out.phylip,
	...
	PRANK(PHYML_TREE.out.NT_alignment,
	...
	GET_ANCESTOR_FNA(PRANK.out.prank_fas,
	...
	LALIGN(GET_ANCESTOR_ORFS.out.ancestor_ORF,
				params.focal)
 }
